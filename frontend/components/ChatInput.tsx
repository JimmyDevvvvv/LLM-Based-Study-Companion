...
export default function ChatInput({
  ...
  return (
    <div
      className={`relative sticky bottom-0 border-t backdrop-blur-2xl transition-all duration-500 ${
        isDark
          ? "border-slate-800/50 bg-slate-950/70"
          : "border-slate-200/60 bg-white/80"
      } shadow-[0_-25px_80px_-40px_rgba(99,102,241,0.35)]`}
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-6">
        {selectedFile && (
          <div
            className={`${theme.surfaceMuted} flex items-center gap-3 px-4 py-3 mb-4 animate-in slide-in-from-bottom-4 shadow-xl`}
          >
        ...
        >
          ...
          <span className="tracking-wide">
            StudyMind can sometimes misstep — verify important facts.
          </span>
